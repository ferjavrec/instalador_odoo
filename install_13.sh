...
#Descargamos odoo version 13 desde git:
sudo git clone --depth 1 --branch 13.0 https://github.com/odoo/odoo /opt/odoo/odoo
...
wget https://github.com/wkhtmltopdf/wkhtmltopdf/releases/download/0.12.5/wkhtmltox_0.12.5-1.bionic_amd64.deb && sudo dpkg -i wkhtmltox_0.12.5-1.bionic_amd64.deb
